...
- When you browse or visit our website, {{< rawhtml >}}(<a class="bold-link" href="https://claritus.io">https://claritus.io</a>){{< /rawhtml >}} ("Website")
...
2. ###### Terms of use
    ...
    This Privacy Policy forms part of our End User License Agreement which is available at {{< rawhtml >}}<a class="bold-link" href="/terms">https://claritus.io/terms</a>{{< /rawhtml >}} ("Terms").
...
4. ###### What information we collect, why we collect it, and how it is used
    ...
    <div class="table-wrapper">
        <table class="table">
            ...
            <tbody>
                <tr class="no-border"><td colspan="4" class="has-bg">When you browse or visit our Website</td></tr>
                <tr class="no-border">
                    <td>Cookies, analytic tools and log files</td>
                ...
                <tr class="no-border"><td colspan="4" class="has-bg">When you sign up for an account or login to our Platform</td></tr>
                <tr>
                    <td>
                        <ul class="no-title">
                            <li>Full name</li>
                ...
                <tr class="no-border"><td colspan="4" class="has-bg">When you make use of the Platform for its intended use (e.g., to  view your financial information and to gain insights into such information)</td></tr>
                <tr>
                    <td>
                        <ul class="no-title">
                            <li>Full name</li>
...
6. ###### How we share your personal information
    ...
    * Where we receive requests for information from law enforcement or regulators, we carefully validate these requests before any Personal Information is disclosed.
    ...
    If you want to receive the list of recipients of your Personal Information, please make your request by contacting us to {{< rawhtml >}}<a class="bold-link" href="mailto:privacy@claritus.io">privacy@claritus.io</a>{{< /rawhtml >}}
...
9. ###### How can i delete my account?
    ...
    Should you ever decide to delete your Account, you may do so by emailing {{< rawhtml >}}<a class="bold-link" href="mailto:help@claritus.io">help@claritus.io</a>{{< /rawhtml >}}.
...
10. ###### Links to and interaction with third parties
...
13. ###### Analytics tools
    * **Google Analytics.** The Services uses a tool called "Google Analytics" to collect information about use
    ...
    * **Facebook Pixels and SDKs.** We use Facebook pixels or SDKs, which are tools that provide help to
...
14. ###### Access/accuracy
    ...
    {{< rawhtml >}}<a class="bold-link" href="mailto:help@claritus.io">help@claritus.io</a>{{< /rawhtml >}}. Your email should include adequate details of your request.
...
15. ###### California privacy rights
    ...
    direct marketing purposes. To make such a request, please send an email to {{< rawhtml >}}<a class="bold-link" href="mailto:help@claritus.io">help@claritus.io</a>{{< /rawhtml >}}.

...
application ("**Platform**"). 
    ...
    1. When you sign up for an account or login to our Platform 
    2. When you make use of the platform for its intended use (e.g., to  view your financial information 
    and to gain insights into such information)
    
The Website together with the Platform is referred to herein as the "**Services**".
